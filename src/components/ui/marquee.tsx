...
export const MarqueeFade: React.FC<MarqueeFadeProps> = ({ className, side, ...props }) => (
  <Box
    className={cn(
      "absolute top-0 bottom-0 z-10 h-full w-4 from-background to-transparent sm:w-8 md:w-16 lg:w-32",
...
export const MarqueeItem: React.FC<MarqueeItemProps> = ({ className, ...props }) => (
  <Box className={cn("mx-2 shrink-0 object-contain", className)} {...props} />
)
